...
public class PoliceLoginActivity extends AppCompatActivity {
    ...
    private static final String[] DUMMY_CREDENTIALS = new String[]{
            "10000:hello", "bar@example.com:world"
    };
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRegisterButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                Intent myIntent = new Intent(PoliceLoginActivity.this,PoliceRegisterActivity.class);
    ...
    private void attemptLogin() {
        ...
        if (TextUtils.isEmpty(pId)) {
            ...
            cancel = true;
        } else if(!isPoliceIdValid(pId)) {
            mPoliceIdView.setError(getString(R.string.error_invalid_id_number));
            focusView = mPoliceIdView;
            cancel = true;
        }
    ...
    private boolean isPoliceIdValid(String pId) {
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                Intent myIntent = new Intent(PoliceLoginActivity.this,PoliceMainActivity.class);
                setResult(2);
                myIntent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
                PoliceLoginActivity.this.startActivity(myIntent);
                finish();
            } else {
                mPoliceIdView.setError(getString(R.string.error_incorrect_pId));
